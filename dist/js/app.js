...
accordionItems.forEach(item => {
   const btn = item.querySelector('.service__accordion-btn');
   ...
   btn.addEventListener('click', () => {
      ...
      accordionItems.forEach(i => {
         ...
         i.querySelector('.service__accordion-text').style.maxHeight = null;
      });

      if (!isActive) {
         item.classList.add('active');
         const content = item.querySelector('.service__accordion-text');
